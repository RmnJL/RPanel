...
wellcomeINSTALL() {
  echo -e "${YELLOW}************ RPanel v1.0.1 Nginx Web Server ************"
  echo -e "${GREEN}  نسخه فعلی: RPanel v1.0.1"
  echo -e "${GREEN}  سورس گیت‌هاب: https://github.com/RmnJL/RPanel"
  echo -ne "${GREEN}\nبرای ادامه Enter را بزنید : ${ENDCOLOR}"
  read n
}
userINPU() {
